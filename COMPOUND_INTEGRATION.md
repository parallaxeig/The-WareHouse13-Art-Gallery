...
export const useInterestRates = () => {
  ...
  useEffect(() => {
    const fetchRates = async () => {
      ...
      const cUSDCRate = await compound.getSupplyRate('cUSDC');
...
1. **Install Dependencies**: `npm install @compound-finance/compound-js ethers`
2. **Connect Wallet**: Use MetaMask or WalletConnect
3. **Approve NFT**: Approve NFT transfer to lending contract
4. **Deposit Collateral**: Supply NFT as collateral
5. **Start Earning**: Begin earning interest on supplied assets

## Support & Documentation

- **Documentation**: [docs.warehouse13.gallery](https://docs.warehouse13.gallery)
- **Discord**: [discord.gg/warehouse13](https://discord.gg/warehouse13)
- **GitHub**: [github.com/warehouse13/compound-integration](https://github.com/warehouse13/compound-integration)
- **Technical Support**: support@warehouse13.gallery
